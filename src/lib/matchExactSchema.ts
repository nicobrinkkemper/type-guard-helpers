...
/**
 *
 * Given a Schema, returns a Type Guard that will check the the given value is a object exactly implementing the entries of the Schema.
 *
 * This Type Guard will return false if a given value contains keys that are not specified in the Schema.
...
>(
	...
	const hasValidEntries = guardEntries(matchEntry(schema));
